...
***************/
	...
	// To solve the puzzle: rotate -15 degrees around the z axis       Remember sin, cos in radiants
	A->Matrix(2,
			  cos(glm::radians(-15.0f)), -sin(glm::radians(-15.0f)), 0, 0,
			  sin(glm::radians(-15.0f)), cos(glm::radians(-15.0f)), 0, 0,
			  0, 0, 1, 0,
